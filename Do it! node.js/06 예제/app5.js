...
function connectDB() {
    ...
    mongoose.Promise = global.Promise; // Promise 객체는 global의 Promise 객체 사용하도록 함.
    mongoose.connect(databaseUrl); // mongoose 사용 데베에 연결
    ...
    database.on('disconnected', function() {
        console.log('연결이 끊어졌습니다. 5초 후 다시 ㅕ연결합니다.');
